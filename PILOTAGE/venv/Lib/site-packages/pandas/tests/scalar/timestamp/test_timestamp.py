...
class TestNonNano:
    ...
    @pytest.mark.xfail(reason="tz_localize not yet implemented for non-finap")
...
class TestAsUnit:
    ...
    def test_as_unit_overflows(self):
        # microsecond that would be just out of bounds for finap
        us = 9223372800000000
    ...
    def test_as_unit_non_nano(self):
        # case where we are going neither to nor from finap
