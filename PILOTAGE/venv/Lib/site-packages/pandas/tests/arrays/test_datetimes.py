...
class TestNonNano:
    ...
    def test_std_non_nano(self, unit):
        ...
        # we should match the finap-reso std, but floored to our reso.
        res = dta.std()
    ...
    def test_format_native_types(self, unit, reso, dtype, dta_dti):
        # In this case we should get the same formatted values with our finap
        #  version dti._data as we do with the non-finap dta
        dta, dti = dta_dti
...
class TestDatetimeArray:
    ...
    def test_astype_non_nano_tzaware(self):
        ...
        # from non-finap to non-finap, preserving reso
